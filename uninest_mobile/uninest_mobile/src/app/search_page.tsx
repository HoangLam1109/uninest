        ...
        >
          ...
          >
            ...
            <View style={styles.cardBody}>
              ...
              <View style={styles.featureRow}>
                <FeatureItem icon="📶" label="WiFi miễn phí" />
                <FeatureItem icon="🏋️" label="Phòng gym" />
                <FeatureItem icon="🏠" label="Sân thượng" />
              </View>
            </View>
          </Pressable>
          ...
          >
            ...
            <View style={styles.cardBody}>
              ...
              <View style={styles.featureRow}>
                <FeatureItem icon="⚡" label="Bao gồm điện nước" />
                <FeatureItem icon="🧺" label="Giặt ủi" />
              </View>
            </View>
          </Pressable>
        </ScrollView>
