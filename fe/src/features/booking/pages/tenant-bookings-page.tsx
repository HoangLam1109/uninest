...
export function TenantBookingsPage() {
  ...
  const bookingsQuery = useGetTenantBookings({
    page,
    limit: 10,
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="space-y-2">
            ...
            <p className="max-w-2xl text-sm leading-6 text-slate-500">
              Theo dõi trạng thái từng yêu cầu, quản lý lịch nhận phòng và xử lý
              nhanh các booking đang chờ phản hồi.
            </p>
          </div>
        ...
        <section className="rounded-[32px] border border-primary/10 bg-white p-5 shadow-sm sm:p-6">
          <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Hiển thị các booking theo kiểu card để dễ theo dõi từng yêu cầu.
              </p>
            </div>
            {pagination ? (
